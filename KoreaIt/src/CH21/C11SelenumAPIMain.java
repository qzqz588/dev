...
public class C11SelenumAPIMain {
    ...
    private static final String WEB_DRIVER_PATH="C:\\Users\\Administrator\\IdeaProjects\\dev\\KoreaIt\\src\\Driver\\chromedriver.exe";
...
//        options.addArguments("--sandbox");
        ...
        WebElement searchEl = driver.findElement(By.id("query")); //query라는 id선택자를 찾아서 searchEL에 대입
