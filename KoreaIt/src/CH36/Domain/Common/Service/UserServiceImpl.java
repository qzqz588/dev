...
public class UserServiceImpl {
    ...
    //회원수정(2)
    public boolean memberSet(UserDto userDto) throws Exception {
        return userDaoImpl.update(userDto) >0;
    }
    //회원탈퇴(3)
    public boolean memberDelete(UserDto userDto) throws Exception {
        return userDaoImpl.delete(userDto.getUsername()) > 0;
    }
    //회원정보조회(4)
    //회원전체정보조회(5)
