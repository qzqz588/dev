...
class Profile {
   ...
   private String major;
    ...
    public String toString() {
        return "Profile :"+
                "name : " + name + " addr : " + addr + "job : " + job + "major : " + major + "}";
    }
    //기능
    ...
    boolean isEquals(String str) {
        ...
        //아니면 false 를 리턴
        String[] hong = str.split(",");
        if (hong[0].equals(this.name) && hong[1].equals(this.addr) && hong[2].equals(this.job) && hong[3].equals(this.major)){
            return true;
        } else{
            return false;}
    }
